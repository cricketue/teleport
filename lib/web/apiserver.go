...
func NewHandler(cfg Config, opts ...HandlerOption) (*RewritingHandler, error) {
	...
	h.GET("/webapi/sites/:site/namespaces/:namespace/nodes/:node/:login/scp", h.WithClusterAuth(h.downloadFile))
	h.POST("/webapi/sites/:site/namespaces/:namespace/nodes/:node/:login/scp", h.WithClusterAuth(h.uploadFile))
