...
// httpFileSystem provides an API over HTTP response/request objects to
// manage file specific methods during scp file transfer
...
// while processing HTTP download request
...
// is not supported during HTTP download.
...
// IsDir tells if a file is a directory. It always returns false as
